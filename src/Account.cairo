...
// Based on OpenZeppelin Contracts for Cairo v0.6.0 (account/presets/Account.cairo)
...
from src.library import Account, AccountCallArray
...
@external
func setWhitelistedContract{
    syscall_ptr: felt*,
    pedersen_ptr: HashBuiltin*,
    range_check_ptr
} (address: felt, allowed: felt) {
    Account.set_whitelisted_contract(address, allowed);
    return ();
}
